...
// Define the ws2812b_set_pixel function to set a specific pixel in the LED matrix
void ws2812b_set_pixel(uint16_t pixel, uGRB32_t grb) {
    ws2812b_put(pixel, grb);
}
